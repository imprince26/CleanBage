...
const CreateBin = () => {
  ...
  const form = useForm({
    ...
    defaultValues: {
      location: {
        coordinates: [23.0225, 72.5714], // Default coordinates for Ahmedabad
        address: {
          street: "",
          area: "",
          landmark: "",
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        navigate(`/admin/bins/${response.data.data._id}`);
      }
    } catch (error) {
  ...
  return (
    <div className="container max-w-3xl py-8 space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Create New Bin</CardTitle>
          <CardDescription>
            Add a new waste bin to the management system
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <CardContent className="space-y-6">
              ...
              <Alert className="bg-yellow-50 border-yellow-200">
                ...
                <AlertDescription>
                  Make sure to verify the location details before creating the bin.
                  The bin ID will be automatically generated.
                </AlertDescription>
              </Alert>
            </CardContent>
