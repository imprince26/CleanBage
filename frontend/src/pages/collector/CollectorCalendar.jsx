  ...
  const fetchMonthSchedules = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/schedules/collector/upcoming?startDate=${startDate.toISOString()}&endDate=${endDate.toISOString()}`
      );
      ...
      >
        ...
        <ScrollArea className="h-[80px]">
          {daySchedules.map((schedule) => (
            <TooltipProvider key={schedule._id}>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant="ghost"
                    size="sm"
                    className={`w-full mb-1 justify-start text-left text-xs truncate ${
          ...
          {selectedSchedule && (
            <>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium">
                      {format(
                        new Date(selectedSchedule.scheduledDate),
                        "PPp"
                      )}
                    </p>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <p>{selectedSchedule.bin.location.address}</p>
                  </div>
                </div>
              ...
              <DialogFooter>
                ...
                <Button asChild>
                  <Link to={`/collector/bins/${selectedSchedule.bin._id}`}>
                    View Bin Details
                  </Link>
                </Button>
              </DialogFooter>
